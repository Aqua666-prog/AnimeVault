...
data class DownloadEntity(
    ...
    @ColumnInfo(name = "stream_provider_id") val streamProviderId: String?,
    @ColumnInfo(name = "stream_provider_name") val streamProviderName: String?,
    @ColumnInfo(name = "source_host") val sourceHost: String?,
    val status: String,
